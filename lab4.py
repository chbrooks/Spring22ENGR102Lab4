...
#  To turn in: add your code to this project, and add the plots described below to your repo.
...
## Task 1. Create five different states with different s,i,r, and t values.
...
## Task 2. Try writing a for loop to start with 90% of the population susceptible and 10% infected and run for 20 iterations.\\
## At each iteration, print out S,I,R and time.
## what happens?
## Run the loop with a larger beta. What happens?
## What if we increase gamma? Run the loop with a larger gamma. What happens?
...
## Task  6. Write a function which contains a loop that calls simulate 8 times, for handwashing factors of
# 0.1, 0.2, ...,0.9, captures the total number of students infected, and then plots those.

## add your plots to  your repo, and push everything to submit!